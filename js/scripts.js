$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Nico & Ana's Wedding",

            // Event start date
            start: new Date('Oct 05, 2019 12:00'),
            ...
            end: new Date('Oct 05, 2019 00:00'),

            // Event Address
            address: 'Cripta de la Catedral de la Almudena, C78M+5W Madrid',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues contact Nico at +34 622528938."
        }
    });
...
// Google map
function initMap() {
    var itc_kol = {lat: 40.4153815, lng: -3.7173483};
